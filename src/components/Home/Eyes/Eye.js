...
const Eye = () => {
  ...
  const { data } = eyes;
  const eyerows = [{ id: "0", title: "jyhhhj", description: "asdf" }];
    ...
    <div className="grid-container">
      <div id="1" className="lip lip--stick lip--img">
        <IconButton
          ...
          onClick={addToFavorite(eye1._id)}
        >
          <Favorite />
        </IconButton>
      ...
      <div id="0" className="lip lip--mask lip--img">
        <IconButton
          className={classes.favoriteicon}
          onClick={addToFavorite(eye0._id)}
        >
          <Favorite />
        </IconButton>
        <div className="content">
      ...
      <div id="2" className="lip lip--glass lip--img">
        <IconButton
          className={classes.favoriteicon}
          onClick={addToFavorite(eye2._id)}
        >
          <Favorite />
        </IconButton>
        <div className="content">
      ...
      <div id="3" className="lip lip--oil lip--img">
        <IconButton
          className={classes.favoriteicon}
          onClick={addToFavorite(eye3._id)}
        >
          <Favorite />
        </IconButton>
        <div className="content">
          <Link to={`/products/61b78509fecfbf08a0a56b10`}>
            <div>
              <h2>eyebrow crame</h2>
              <h5>
                A tinted gel-cream that fills in, shapes and defines your brows.
              </h5>
